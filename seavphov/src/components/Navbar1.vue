<template>
  <!-- Navbar-->
  <nav class="navbar navbar-expand-lg bg-seavphov p-0" style="height: 4rem">
    <div class="container-fluid justify-content-between">
      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        ...
        <!-- Center elements -->
        <ul class="navbar-nav flex-row d-none d-md-flex navbar-brand">
        ...
        <!-- Right elements -->
        <ul
          class="navbar-nav flex-row justify-content-center align-items-center"
        >
          ...
          <!-- Chat dropdown -->
          <li
            class="nav-item dropdown me-2 d-sm-flex align-items-sm-center"
          ...
          <li
            class="nav-item dropdown me-3 d-sm-flex align-items-sm-center"
            v-if="this.$store.getters.loggedInState"
          >
            <a
              class="nav-link dropdown-toggle hidden-arrow"
